...
public class Report implements DBEntity, Serializable,
		Comparable<Report>{
	...
	@Override
	 public int hashCode()
	 {
	    final int PRIME = 31;
	    int result = 1;
	    result = (int) (PRIME * result + (getId()==null?0:getId())+this.getInstitution().hashCode()+this.getPerEnd().hashCode()+this.getPerStart().hashCode());
	    return result;
	 }
