...
public class PersonPriv extends com.leosal.util.jpa.Entity implements Serializable,
	...
	@Override
	 public int hashCode()
	 {
	    final int PRIME = 31;
	    int result = 1;
	    result = PRIME * result + getPrivId()+(getPerson()!=null?(getPerson().getId()!=null?getPerson().getId():0):0);
	    return result;
	 }
