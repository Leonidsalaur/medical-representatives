...
public class Event extends com.leosal.util.jpa.Entity implements Serializable,
	Comparable<Event>{
	...
	@OneToMany(mappedBy="event", cascade={CascadeType.REMOVE,CascadeType.PERSIST, CascadeType.MERGE})
	...
	@Override
	 public int hashCode()
	 {
	    final int PRIME = 31;
	    int result = 1;
	    result = PRIME * result + (getId()==null?hashGenerator++:getId());
	    return result;
	 }
