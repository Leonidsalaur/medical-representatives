...
@Component
@Scope("prototype")
public class Contacts extends JInternalFrame{
	...
	private ArrayList<ContactDTO> modified, deleted;
...
//		txtFilter.setColumns(10);
		...
		*/
		...
		JButton btnAddInstitution = new JButton("Add");
...
//		btnAddInstitution.setIcon(new ImageIcon(Contacts.class.getResource("/com/leosal/medrepear/frames/Graphics/list-add.png")));
		...
		JButton btnModifyInstitution = new JButton("Edit");
...
//		btnModifyInstitution.setIcon(new ImageIcon(Contacts.class.getResource("/com/leosal/medrepear/frames/Graphics/document-edit.png")));
		...
		JButton btnDeleteInstitution = new JButton("Delete");
...
//		setSaved(false);
	...
	public void extract() {
		...
		System.out.println(contacts.size() + " contacts extracted");
	}
